# Data
data <- read.csv("C:\\Users\\piyush.jhamb\\Documents\\CPBAE\\RegressionPractice\\ClassImbalanceProblem\\binary.csv", header = TRUE)
str(data)
...
## Get ROC curve and AUC values using ROCR package:
library(ROCR)
pred <- predict(rftrain, test, type = 'prob')
pred <- prediction(pred, test$admit)
